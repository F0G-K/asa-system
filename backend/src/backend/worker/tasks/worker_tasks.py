...
from backend.application.commands.execute_stage import dispatch_next_stage_after_commit
...
async def _cancel_after_request(payload: WorkerTaskPayload) -> None:
    from backend.application.commands.cancel_project import CancelProjectCommand
