...
from backend.api.stage_dispatcher import CeleryApiStageDispatcher
from backend.application.ports.project_repository import StartProjectResources
from backend.application.ports.project_task_dispatcher import ProjectTaskDispatcher
from backend.application.ports.stage_task_dispatcher import StageTaskMessage
    ...
    async def dispatch_stop(
        ...
        *,
        ...
        try:
            ...
            Celery("backend_api_dispatcher", broker=broker_url).send_task(
